  ...
  return (
    <div className="bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-10 min-h-[60vh]">
        ...
        <p className="text-gray-600 mb-8">Accepted payment methods, pricing, taxes, and billing on Quickfynd.com.</p>
        ...
        <div className="space-y-6 bg-white border border-gray-200 rounded-xl p-6">
          ...
          <section>
            ...
            <p className="text-gray-700">Prices are displayed in rs unless stated otherwise. Promotional prices are valid only during the indicated time. Final price is shown at checkout.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-gray-700">If you notice an incorrect charge, contact support@Quickfynd.com with your order ID. We’ll investigate and resolve promptly.</p>
          </section>
        </div>
      </div>
    </div>
