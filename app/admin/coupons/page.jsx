    ...
    return (
        <div className="text-slate-500 mb-40">
            ...
            <form onSubmit={(e) => toast.promise(handleAddCoupon(e), { loading: "Adding coupon..." })} className="max-w-sm text-sm">
                ...
                <input type="number" placeholder="Minimum Cart Value (Rs)" min={0} className="w-full mt-2 p-2 border border-slate-200 outline-slate-400 rounded-md"
                        ...
                        <tbody className="divide-y divide-slate-200">
                            {coupons.map((coupon) => (
                                <tr key={coupon.code} className="hover:bg-slate-50">
                                    ...
                                    <td className="py-3 px-4 text-slate-800">Rs{coupon.minPrice}</td>
